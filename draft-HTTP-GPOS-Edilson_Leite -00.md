**Working Group Name**  **Edilson Leiete**
...
## 1. Introduction
Este protocolo tem como objetivo requisitar a geolocalização (latitude, longitude e altitude) de um site.
...
O cliente envia uma requisição ao servidor desejado com o header:
>GET <nome do arquivo desejado.extensão> <versão do HTTP> HOST: <url do host> GPOS: <nome_dispositivo>
O serviror, pos sua vez, retorna uma resposta assim:
><nome_dispositivo> <ttl> <classe> GPOS <latitude> <longitude> <altitude>
...
[RFC1912]	Farrell, Schulze, Pleitner & Baldoni  (Authors), "DNS Encoding of Geographical Location", RFC 1912,
Curtin University of Technology, November 1994.
